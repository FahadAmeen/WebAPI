...
namespace WebApiProject.Migrations
{
    ...
    [Migration("20190729034642_logginggg")]
    partial class logginggg
    {
            ...
            modelBuilder.Entity("WebApiProject.Models.UserLogin", b =>
                {
                    ...
                    b.HasData(
                        new { id = 1, Password = "aaaa", SPassword = new byte[] { 18, 69, 13, 228, 203, 34, 233, 132, 180, 67, 231, 158, 207, 251, 95, 204 }, email = "sahar@gmail.com" },
                        new { id = 2, Password = "bbbb", SPassword = new byte[] { 107, 227, 108, 3, 238, 90, 23, 11, 163, 75, 245, 104, 120, 153, 41, 165 }, email = "sana@hotmail.com" },
                        new { id = 3, Password = "cccc", SPassword = new byte[] { 145, 134, 24, 6, 93, 72, 139, 45, 135, 150, 116, 211, 135, 210, 30, 154 }, email = "rida@yahoo.com" }
                    );
                });
